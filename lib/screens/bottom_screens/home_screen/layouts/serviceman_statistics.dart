                      ...
                      Align(
                          ...
                          child: Container(
                            ...
                            child: SvgPicture.asset(e.value["image"].toString(),
                              ...
                              color: appColor(context).appTheme.whiteColor,
                              shape: BoxShape.circle))
                    ]).height(Sizes.s125).width(Sizes.s110).inkWell(onTap:() => value.onStatisticTapOption(
              e.key, context)))
          ]).paddingSymmetric(horizontal: Insets.i20).marginOnly(bottom: Insets.i20),
        );
      }
    );
  }
