...
class AvailableServiceLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      CachedNetworkImage(
          imageUrl: data!.media != null ? "" : data!.media![0].originalUrl!,
      ...
      IntrinsicHeight(
        ...
        Expanded(
            child: Text(
                "${language(context, appFonts.since)} ${DateFormat("yyyy").format(DateTime.parse(data!.createdAt!))}",
