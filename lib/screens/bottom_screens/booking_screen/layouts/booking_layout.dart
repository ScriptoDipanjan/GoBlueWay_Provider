...
class BookingLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // log("data!.totalExtraServicemen:::${data!.totalExtraServicemen}");
    // log("data!.totalExtraServicemen:::${"${((data!.requiredServicemen ?? 1) + (data!.totalExtraServicemen != null ? (data!.totalExtraServicemen ?? 1) : 0))} ${language(context, appFonts.serviceman)}"}");
    return Stack(
