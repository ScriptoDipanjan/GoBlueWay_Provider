...
class BidAmountSheet extends StatelessWidget {
  const BidAmountSheet({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer2<HomeProvider,JobRequestDetailsProvider>(builder: (context1, value,job, child) {
      return Padding(
              ...
              child: Column(
                  ...
                  children: [
                    Row(
                        ...
                        children: [
                          Text(language(context, appFonts.bidAnEstimatedPrice),
                        ...
                        child: Form(
                          ...
                          child: Column(children: [
                            ...
                            BottomSheetButtonCommon(
                                ...
                                textTwo: appFonts.confirm,
                                applyTap: ()=> job.bidSend(context),
                                clearTap: () {
                                  job.amountCtrl.text ="";
