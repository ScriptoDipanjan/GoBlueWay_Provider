...
final bool isDetailShow;
  const CustomerLayout({super.key, this.data, this.title,this.isDetailShow=true});
    ...
    return SizedBox(
      ...
      Column(
        children: [
          ...
          if (data!.phone != null)
            ContactDetailRowCommon(image: eSvgAssets.phone, title: data!.phone != null ? data!.phone.toString().replaceRange(0, data!.phone.toString().length, "*") :"")
                .paddingSymmetric(vertical: Insets.i15),
